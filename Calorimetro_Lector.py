...
class App(tk.Tk):
    ...
    def _panel_conexion(self, padre):
        ...
        self._lbl(self.frame_tcp,"Nueva IP:").grid(row=1,column=0,sticky="w",pady=(4,0))
        self.nueva_ip_var = tk.StringVar(value="")
        self._entry(self.frame_tcp, self.nueva_ip_var, 16).grid(row=1,column=1,padx=4,pady=(4,0))
        tk.Button(self.frame_tcp, text="  Cambiar IP",
                  command=self._enviar_nueva_ip,
                  bg=COLOR_OK, fg="#1e1e2e",
                  font=("Consolas",9,"bold"),
                  relief="flat", padx=8,
                  cursor="hand2").grid(row=1,column=2,columnspan=2,padx=4,pady=(4,0),sticky="w")
        ...
        self._lbl(self.frame_serie,"Nueva IP:").grid(row=1,column=0,sticky="w",pady=(4,0))
        self._entry(self.frame_serie, self.nueva_ip_var, 16).grid(row=1,column=1,padx=4,pady=(4,0))
        tk.Button(self.frame_serie, text="  Cambiar IP",
                  command=self._enviar_nueva_ip,
                  bg=COLOR_OK, fg="#1e1e2e",
                  font=("Consolas",9,"bold"),
                  relief="flat", padx=8,
